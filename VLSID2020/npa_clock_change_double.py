...
report_filename="report_npa_heat_map_data_len.txt"
...
for f in range (len(text_files)):
    ...
    voltage=float(analogfile[9:vln])
    print("V:", voltage)
    ...
    appendFile.write(' ')
    appendFile.write(str(sum(change_fp_number)/49))
    appendFile.write('\n')
