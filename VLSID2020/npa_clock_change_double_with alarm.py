...
Update: 3.21.19 12.59 pm for npa capability
...
#file
report_filename="report_npa_v1_hm_data.txt"
dcng_file="npa_double_v1_change.txt"
...
for f in range (len(text_files)):
    ...
    filename="npa_clockhm_v1_data_alarm.txt"
