...
update: 3.21.19 4.15am #temperature file update"""
...
makemydir("temperature_plots_per")
...
for temper in range (0,41,4):
    ...
    for f in range (len(text_files)):
        ...
        appendFile.close()"""
        miss_alarm_per= [round((x/11)*100,2) for x in miss_alarm]
        false_alarm_per = [round((y/11)*100,2) for y in false_alarm]
        ...
        plotdatafile="./temperature_plots_per/t_"+str(temper)+"_miss_false_st.dat"
