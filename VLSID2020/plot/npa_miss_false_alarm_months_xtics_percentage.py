...
update: 5.2.2019 12.33 pm) percentage of the total alarms"""
...
miss_alarm_per= [round((x/33)*100,2) for x in miss_alarm]
false_alarm_per = [round((x/33)*100,2) for x in false_alarm]

miss_alarm=miss_alarm_per
false_alarmr=false_alarm_per

print("miss_alarm: ", miss_alarm)
print("\n")
print("false_alarm: ", false_alarm)

plotdatafile="npa_miss_false_per.dat"
