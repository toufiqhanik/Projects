...
file= open("./AES_HOST_24_LFSR_seed_list_1000_repeat_10k_ct_all.csv", "r")
...
for bit in range (0,8):
    HD_file= open("AES_HOST_24_LFSR_seed_list_1000_repeat_10k_ct_all_HD_bit%d.csv" %bit, "w")
    for l in trange (0, len(lines)):
        ...
        for n in range (0, 16):        
            ...
            for k in range(0, 256):
                ...
                hd=hd_memory[bit]#.count("1")
                
                csv_str=csv_str+str(hd)+","
