...
file= open("../process_data/processed_data/sensor_aes_sca_24mhz_v150V_carry4_q10000_v1_pt.txt", "r")

HD_file= "sensor_aes_sca_24mhz_v150V_carry4_q10000_v1_pt_textbytes.npy"
bits=128
scale = 16
...
for l in trange (0, len(lines)):
    ...
    for n in range (0, 16):        
        #memory=int(memory_all[8*n:(n+1)*8],2)
        memory=int(memory_str[2*n:(n+1)*2],16)
        textbytes[l, n]=memory
        print(memory)
            # print(new_memory)
            # print(hd_memory)
            # print(hd)
